...
(function(window, document, undefined) {
	 ...
	 */
			...
			TableTools.buttonBase = {
				...
				"sNewLine": "auto",
				"mColumns": "all",
				/* "all", "visible", "hidden" or array of column integers */ "bHeader": true,
				"bFooter": true,
				"bOpenRows": false,
				"bSelectedOnly": false,
			...
			TableTools.BUTTONS = {
				...
				"extenxls": $.extend({}, TableTools.buttonBase, {
					"sAction": "flash_save",
					"sCharSet": "utf16le",
					"bBomInc": true,
					"sFileName": "*.csv",
				...
				"copy": $.extend({}, TableTools.buttonBase, {
					...
					"fnComplete": function(nButton, oConfig, flash, text) {
						...
						lines = text.split('\n').length,
							...
							plural = (len == 1) ? "" : "s";
						this.fnInfo('<h6>列表复制</h6>' +
							'<p>已经复制了 ' + len + ' 条' + plural + ' 在你的剪贴板.</p>',
							1500
						);
					}
				}),
			...
			TableTools.DEFAULTS = {
				...
				"aButtons": ["copy", "csv", "xls", "pdf", "print","extenxls"],
				"oTags": {
					"container": "div",
